        ...
        <div class="tab-content">
            ...
            <div id="project-dash" class="tab-pane fade in active">
                ...
                <div style="display: inline-block; width: 100%; text-align: center; margin: auto">
                    <span style="font-size: 2em; ; text-align: center"> <?php echo $_SESSION['username_hbdi'] . "'s"?> Dashboard </span>

                    <!-- create New Project button -->
                    <button style="display: inline;float: right; font-weight: 500; color: #EEEEEE;
            padding: 7px 13px; border-radius: 10px; background-color: #782f40; position: relative; z-index:0 ">
                ...
                <div style="text-align: center">
                    ...
                    <input style="width: 500px;  padding: 5px 6px; border-radius: 2px; text-align: left; overflow: hidden"
                ...
                <div class="dashboard-wrapper">
                    <div class="grid-container">
                        ...
                        <!-- Projects Grid -->
                        <!-- grid #1: Projects -->
                        <div class="grid-block" style="background-color: ">
                            ...
                            <?php
                            try {
                                $stmt = $pdo->prepare(" SELECT title_project_short, title_project FROM project WHERE id_creator = '$id_user' ");
                                $stmt->execute();
                                $result = $stmt->fetchAll();
                                foreach ($result as $row) {
                                    echo "<div class='block-item'>" . "<a href='http://tychen.us/hbdi/projects/" . $username_hbdi . "/" . $row['title_project_short'] . ".php'>" . $row['title_project_short'] . ": " . $row['title_project'] . "</a> </div>" ;
                                }
...
<!--                            <span class="postfix"> 02-15-20</span>-->
                        ...
                        <div class="grid-block">
                            ...
                            <div>
                                <div class="block-item"><a href="dashboard.php"> MRI and Alzheimers images </a></div>
